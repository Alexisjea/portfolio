 ...
 */
final class Version20210709165348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parcours ADD date VARCHAR(255) NOT NULL, ADD titre VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parcours DROP date, DROP titre');
    }
}
